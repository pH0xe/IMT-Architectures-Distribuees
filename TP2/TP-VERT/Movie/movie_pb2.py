...
_EMPTYMOVIE = _descriptor.Descriptor(
  name='EmptyMovie',
  full_name='EmptyMovie',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
EmptyMovie = _reflection.GeneratedProtocolMessageType('EmptyMovie', (_message.Message,), {
  'DESCRIPTOR' : _EMPTYMOVIE,
  '__module__' : 'movie_pb2'
  # @@protoc_insertion_point(class_scope:EmptyMovie)
  })
_sym_db.RegisterMessage(EmptyMovie)
